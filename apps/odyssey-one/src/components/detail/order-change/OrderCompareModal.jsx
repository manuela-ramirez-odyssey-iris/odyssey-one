...
// merged) inside a modal, fed THIS order's rows instead of the shipment's —
// so it reuses that section verbatim. The VD's title reads "Planning Dates"
// (copy leftover from the sibling modal); "Order Changes" until the designer
// confirms (OC-open-9 / Q6).

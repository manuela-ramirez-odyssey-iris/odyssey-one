...
1. **Order errors + other updates** (user-stated S94 focus) — implement order error states; scope with the user at session start. Likely touches the S90 error-state components (see item 4).

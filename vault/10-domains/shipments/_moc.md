...
- [[routing-history|Routing History]] — the Routing History tab (LINX-15895): what a *routing version* is, the six per-version sections, why nothing is stored yet (the backend clears the previous run), and the coherence rules the prototype derives history with

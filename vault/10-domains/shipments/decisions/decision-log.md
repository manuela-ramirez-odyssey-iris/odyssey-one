...
- **Amended later the same day:** the tab signals became floating corner badges (SPB-82); the dropped-carrier badge shows the **count** rather than a glyph, orange; the order-change badge keeps PackageOpen, purple; the Dropped Carrier section title keeps ListX.
